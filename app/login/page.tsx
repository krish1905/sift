...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden">
      ...
      <Link
        href="/"
        className="absolute top-6 left-6 flex items-center gap-2 text-white/50 hover:text-white/70 transition-colors z-10"
      >
        ...
        <Card className="bg-black border border-white/10">
          <CardHeader className="space-y-1 text-center">
            ...
            <CardDescription className="text-white/50">
              {isSignUp 
                ? "Enter your email to sign up for Sift" 
          ...
          <CardContent className="space-y-4">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {error && (
                <div className={`text-xs ${error.includes("Check your email") ? "text-green-400" : "text-red-400"}`}>
                  {error}
                </div>
              )}
          ...
          <CardFooter>
            <p className="text-xs text-center w-full text-white/40">
